...
std::tuple<Tensor, Tensor, Tensor> fastlog_forward_cuda(
    ...
    const Tensor &ori_row_ptr,
    const Tensor &ori_col_ind,
    const Tensor &ori_r_ind,
    const Tensor &ori_mask,
    const Tensor &inv_row_ptr,
    const Tensor &inv_col_ind,
    const Tensor &inv_r_ind,
...
std::tuple<Tensor, Tensor> fastlog_backward_cuda(
    ...
    const Tensor &grad_inv,
    const Tensor &out_ori,
    const Tensor &out_inv,
    const Tensor &A,
    const Tensor &w,
    const Tensor &active_nodes,
    const Tensor &ori_row_ptr,
...
std::tuple<Tensor, Tensor> fastlog_backward_max_cuda(
    ...
    const Tensor &grad_ori,
    const Tensor &grad_inv,
    const Tensor &ori_arg,
    const Tensor &inv_arg,
    const Tensor &A,
    const Tensor &w,
    const Tensor &active_nodes,
    const Tensor &ori_row_ptr,
